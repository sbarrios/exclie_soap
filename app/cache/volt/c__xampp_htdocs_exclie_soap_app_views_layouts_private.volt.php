...
<html>
  <head>
    ...
    <!-- Ionicons -->
    <?php echo $this->tag->stylesheetLink('public/ionicons-2.0.1/css/ionicons.min.css'); ?>
    <!-- Theme style -->
    ...
    <!-- FullCalendar -->
    <?php echo $this->tag->javascriptInclude('public/fullcalendar-2.4.0/lib/moment.min.js'); ?> 
    <?php echo $this->tag->javascriptInclude('public/fullcalendar-2.4.0/fullcalendar.js'); ?> 
    <?php echo $this->tag->javascriptInclude('public/fullcalendar-2.4.0/lib/jquery-ui.custom.min.js'); ?> 
    <?php echo $this->tag->javascriptInclude('public/fullcalendar-2.4.0/lang-all.js'); ?> 
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs"><?php echo $this->auth->getName(); ?></span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="<?php echo $this->url->get('session/logout'); ?>" class="btn btn-default btn-flat">Salir</a>
                    </div>
                  </li>
                </ul>
              </li>
