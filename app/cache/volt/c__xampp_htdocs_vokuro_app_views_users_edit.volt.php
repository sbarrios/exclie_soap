        ...
        <div class="tab-pane" id="B">
            <p>
                <table class="table table-bordered table-striped" align="center">
                    ...
                    <tbody>
                    <?php $v6053198051iterated = false; ?><?php foreach ($user->successLogins as $login) { ?><?php $v6053198051iterated = true; ?>
                        <tr>
                            <td><?php echo $login->id; ?></td>
                            <td><?php echo $login->ipAddress; ?></td>
                            <td><?php echo $login->userAgent; ?></td>
                        </tr>
                    <?php } if (!$v6053198051iterated) { ?>
        ...
        <div class="tab-pane" id="C">
            <p>
                <table class="table table-bordered table-striped" align="center">
                    ...
                    <tbody>
                    <?php $v6053198051iterated = false; ?><?php foreach ($user->passwordChanges as $change) { ?><?php $v6053198051iterated = true; ?>
                        <tr>
        ...
        <div class="tab-pane" id="D">
            <p>
                <table class="table table-bordered table-striped" align="center">
                    ...
                    <tbody>
                    <?php $v6053198051iterated = false; ?><?php foreach ($user->resetPasswords as $reset) { ?><?php $v6053198051iterated = true; ?>
                        <tr>
