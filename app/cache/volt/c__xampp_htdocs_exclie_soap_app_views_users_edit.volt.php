        ...
        <div class="tab-pane" id="B">
            <p>
                <table class="table table-bordered table-striped" align="center">
                    ...
                    <tbody>
                    <?php $v29375619871iterated = false; ?><?php foreach ($user->successLogins as $login) { ?><?php $v29375619871iterated = true; ?>
                        <tr>
                            <td><?php echo $login->id; ?></td>
                            <td><?php echo $login->ipAddress; ?></td>
                            <td><?php echo $login->userAgent; ?></td>
                        </tr>
                    <?php } if (!$v29375619871iterated) { ?>
        ...
        <div class="tab-pane" id="C">
            <p>
                <table class="table table-bordered table-striped" align="center">
                    ...
                    <tbody>
                    <?php $v29375619871iterated = false; ?><?php foreach ($user->passwordChanges as $change) { ?><?php $v29375619871iterated = true; ?>
                        <tr>
        ...
        <div class="tab-pane" id="D">
            <p>
                <table class="table table-bordered table-striped" align="center">
                    ...
                    <tbody>
                    <?php $v29375619871iterated = false; ?><?php foreach ($user->resetPasswords as $reset) { ?><?php $v29375619871iterated = true; ?>
                        <tr>
